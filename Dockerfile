...
RUN wget -qO - https://github.com/chip-in/configure/releases/download/1.2/configure-rpm.tar.gz | tar -xzf -
RUN wget -qO - https://github.com/procube-open/jwt-nginx-lua/releases/download/1.0.3/jwt-nginx-lua.tar.gz | tar -xzf -
RUN wget -qO - https://github.com/chip-in/hmr/releases/download/0.0.14/hmr-rpm.tar.gz | tar -xzf -
