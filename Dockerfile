...
RUN wget -qO - https://github.com/chip-in/configure/releases/download/1.7.10/configure-rpm.tar.gz | tar -xzf -
RUN wget -qO - https://github.com/procube-open/jwt-nginx-lua/releases/download/1.0.8/jwt-nginx-lua.tar.gz | tar -xzf -
RUN wget -qO - https://github.com/chip-in/hmr/releases/download/v0.6.6/hmr-rpm.tar.gz | tar -xzf -
